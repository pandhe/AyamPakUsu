...
public class CountDrawable2 extends Drawable {

    private Paint mBadgePaint, mBoxPaint,mBadgePaint2, mBoxPaint2;
    private Paint mTextPaint,mTextPaint2;
    private Rect mTxtRect = new Rect();
    private Rect mTxtRect2 = new Rect();
    private int dw=0;

    private String mCount = "";
    private boolean mWillDraw;

    public CountDrawable2(Context context,int dw) {
    ...
    public void draw(Canvas canvas) {
        ...
        float centerX2 = width-(circlemargin*2)-(radius*3);
        ...
        switch (dw){
            case 0:
                ...
                if(mCount.length() <= 2){
                    ...
                    canvas.drawCircle(centerX2, centerY, (int)(radius), mBadgePaint);
