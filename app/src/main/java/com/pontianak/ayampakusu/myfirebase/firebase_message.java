package com.pontianak.ayampakusu.myfirebase;
...
import com.pontianak.ayampakusu.MainActivity;
...
public class firebase_message extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getData().size() > 0) {
            Log.i(TAG, "Message data payload: " + remoteMessage.getData());
              ...
              senddatamessage(remoteMessage.getData().get("invoice_id"),remoteMessage.getData().get("title"),remoteMessage.getData().get("body"));
    ...
    private void sendNotification(String messageBody,String messageTitle,String id_invoice) {
       ...
       // Intent intent = new Intent(Config.PUSH_NOTIFICATION);
        ...
        if(!applicationInForeground()){
            ...
            intent.putExtra("invoice_id",id_invoice);
    ...
    public void senddatamessage(String id_invoice,String title,String body){
        Log.i("ez","sending broadcast"+MyConfig.PUSH_NOTIFICATION);



            Intent myintent = new Intent(MyConfig.PUSH_NOTIFICATION);
            myintent.putExtra("title",title);
            myintent.putExtra("body",body);
            myintent.putExtra("invoice_id",id_invoice);
    ...
    private boolean applicationInForeground() {
        ...
        if (services.get(0).processName
            ...
            Log.i("ezact",services.get(0).processName);
            if(Actvity_Name.equals("com.pontianak.ayampakusu.MainActivity"))
            {
